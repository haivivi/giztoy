...
go_repository(
    ...
    sum = "h1:TOpi/QG8iDcZlkQlGlFUti/ZtyLkliXvHDcyUIMuFrU=",
    version = "v0.3.9",
)
...
go_repository(
    ...
    sum = "h1:m4jKsIK0QS9ihQzOxUN2zJcPdrACwqIWCwvdzv9skMQ=",
    version = "v0.0.0-20251001235044-fca9a0999f15",
)

go_repository(
    name = "com_github_itchyny_gojq",
    importpath = "github.com/itchyny/gojq",
    sum = "h1:gFGHyt/MLbG9n6dqnvlliiya2TaMMh6FFaR2b1H6Drc=",
    version = "v0.12.18",
)
...
go_repository(
    ...
    sum = "h1:xyftit9Tbw+Dc/huSSPJaEmX1TVL8lw5vxjJLK4GMMA=",
    version = "v0.1.7",
)
...
go_repository(
    ...
    sum = "h1:wnqy5hrv7p3k7cShwAU/Br3nzod7fxoqG+k0VZ+/Pk0=",
    version = "v0.18.0",
)
...
go_repository(
    ...
    sum = "h1:XbNi5E6bOVEj/uLXQRlt6TKuEzMD7zvW/6tNwltE4P4=",
    version = "v0.260.0",
)
...
go_repository(
    ...
    sum = "h1:pcwUBl8sRRgljKGbSYn4Riy/iVzEiuNBRZnDyrBSHVE=",
