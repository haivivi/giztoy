...
#
# 也可以通过 Bazel 运行:
#   bazel run //examples/doubaospeech/cmd:run -- tts
...
if [[ -n "${BUILD_WORKSPACE_DIRECTORY:-}" ]]; then
    ...
    SCRIPT_DIR="$BUILD_WORKSPACE_DIRECTORY/examples/doubaospeech/cmd"
else
...
print_help() {
    ...
    echo "  bazel run //examples/doubaospeech/cmd:run -- tts"
}
