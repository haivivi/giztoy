...
#   Bazel:    bazel run //examples/minimax/cmd:run -- [runtime] [test_level]
#
...
SCRIPT_DIR="$PROJECT_ROOT/examples/minimax/cmd"
COMMANDS_DIR="$SCRIPT_DIR/commands"
OUTPUT_DIR="$PROJECT_ROOT/examples/minimax/output"
...
main() {
    ...
    case "$runtime" in
        ...
        *)
            ...
            echo "      bazel run //examples/minimax/cmd:run -- [runtime] [test_level]"
            echo ""
            echo "runtime:"
            ...
            echo "示例:"
            echo "  $0 go 1                                        # 直接运行"
            echo "  bazel run //examples/minimax/cmd:run -- go 1   # Bazel 运行"
            echo "  bazel run //examples/minimax/cmd:run -- both quick"
            exit 1
            ;;
    esac
