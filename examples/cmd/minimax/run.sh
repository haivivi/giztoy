...
#   Bazel:    bazel run //examples/cmd/minimax:run -- [runtime] [test_level]
#
...
SCRIPT_DIR="$PROJECT_ROOT/examples/cmd/minimax"
...
main() {
    ...
    case "$runtime" in
        ...
        *)
            ...
            echo "      bazel run //examples/cmd/minimax:run -- [runtime] [test_level]"
            echo ""
            echo "runtime:"
            ...
            echo "示例:"
            echo "  $0 go 1                                        # 直接运行"
            echo "  bazel run //examples/cmd/minimax:run -- go 1   # Bazel 运行"
            echo "  bazel run //examples/cmd/minimax:run -- both quick"
            exit 1
            ;;
    esac
