...
#
# 也可以通过 Bazel 运行:
#   bazel run //go/examples/doubaospeech/cmd:run -- tts
...
if [[ -n "${BUILD_WORKSPACE_DIRECTORY:-}" ]]; then
    ...
    SCRIPT_DIR="$BUILD_WORKSPACE_DIRECTORY/go/examples/doubaospeech/cmd"
else
...
find_doubao_cli() {
    ...
    # Check bazel-bin relative to script (go/examples/doubaospeech/cmd -> project root)
...
test_tts_synthesize() {
    ...
    local config="$SCRIPT_DIR/tts.yaml"
...
test_tts_async() {
    ...
    local config="$SCRIPT_DIR/tts-async.yaml"
...
test_asr_one_sentence() {
    ...
    local config="$SCRIPT_DIR/asr-one-sentence.yaml"
...
test_asr_stream() {
    ...
    local config="$SCRIPT_DIR/asr-stream.yaml"
...
test_realtime() {
    ...
    local config="$SCRIPT_DIR/realtime.yaml"
...
test_podcast() {
    ...
    local config="$SCRIPT_DIR/podcast.yaml"
...
test_meeting() {
    ...
    local config="$SCRIPT_DIR/meeting.yaml"
...
test_translation() {
    ...
    local config="$SCRIPT_DIR/translation.yaml"
...
test_subtitle() {
    ...
    local config="$SCRIPT_DIR/subtitle.yaml"
...
test_voice_train() {
    ...
    local config="$SCRIPT_DIR/voice-train.yaml"
...
print_help() {
    ...
    echo "  bazel run //go/examples/doubaospeech/cmd:run -- tts"
}
